                ...
                {slide.phases.map((phase, idx) => (
                  <div key={idx} className="flex items-start flex-1">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <div className="text-sm text-slate-500 text-center">{phase.description}</div>
                    </div>
      ...
      <div className="h-screen flex overflow-hidden">
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-10 py-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-base text-slate-400 leading-relaxed">Results are not a diagnosis — they help you prepare for a conversation with our team.</p>
          </div>
        </div>
      </div>
    );
